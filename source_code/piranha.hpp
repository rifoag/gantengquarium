...
class piranha : public fish {
    ...
    public:
        ...
        void findFood(double diff, linkedList<guppy>& listGuppy, linkedList<coin>& listCoin);
        ...
        void move(double diff,linkedList<guppy>& listGuppy,linkedList<coin>& listCoin);
