...
class fish : public entity, public movingObject {
    protected:
        ...
        const int FOOD_NEEDED = 4; // Jumlah makanan yang dibutuhkan agar ikan dapat tumbuh
        const int FOOD_RADIUS = 27; // Radius makanan dapat dimakan oleh ikan
        int SPEED = 115;
